<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewSchedule_Teacher.aspx.cs" Inherits="educationDean_viewSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <nav class="nav">
        ...
        <ul>
            <li><a href="viewSchedule_Teacher.aspx" style="background-color: lightgray" >
                <img src="../img/icon7_schedule.png" />查看我的课表
            </a></li>
            <li><a href="viewSchedule_Class.aspx" >
